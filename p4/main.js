...
const main = async () => {
  ...
  console.log(`\niv. 交易费用`)
  console.log(`Gas价格: ${gasPrice.toString()} wei / ${gasPriceInEth} ETH`)
  console.log(`Gas消耗: ${receipt.gasLimit.toString()} gas`)
  console.log(`交易费用: ${ethers.utils.formatEther(receipt.gasLimit.mul(gasPrice))} ETH`)
}
